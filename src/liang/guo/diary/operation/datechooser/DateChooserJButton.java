package liang.guo.diary.operation.datechooser;
...
public class DateChooserJButton extends JButton {
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        private JPanel createYearAndMonthPanal() {
            ...
            daySpin.setPreferredSize(new Dimension(50, 30));
            daySpin.setName("Day");
...
//            hourSpin.setPreferredSize(new Dimension(50, 30));
...
//            minuteSpin.setPreferredSize(new Dimension(50, 30));
...
//            secondSpin.setPreferredSize(new Dimension(50, 30));
...
//            result.add(secondLabel);
        ...
        private JPanel createButtonBarPanel() {
        	...
        	GridBagLayout btnBagLayout = new GridBagLayout();
        	panel.setLayout(btnBagLayout);
    		...
    		btnBagLayout.setConstraints(ok, gridBagConstraints);
    		panel.add(ok);
    		
    		gridBagConstraints.gridx = 1;
    		gridBagConstraints.gridwidth = GridBagConstraints.REMAINDER;
    		btnBagLayout.setConstraints(cancel, gridBagConstraints);
    		panel.add(cancel);
    ...
    public static void main(String[] args) {
        ...
        mainFrame.add(new DateChooserJButton("呵呵"), java.awt.BorderLayout.NORTH);
